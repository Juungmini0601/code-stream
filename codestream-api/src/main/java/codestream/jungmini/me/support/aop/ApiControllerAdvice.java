...
public class ApiControllerAdvice {
    ...
    @ExceptionHandler(CodeStreamException.class)
    public ResponseEntity<ApiResponse<?>> handleCodeStreamException(CodeStreamException exception) {
        switch (exception.getErrorType().getLogLevel()) {
            case ERROR -> log.error("CodeStreamException : {}", exception.getMessage(), exception);
            case WARN -> log.warn("CodeStreamException : {}", exception.getMessage(), exception);
            default -> log.info("CodeStreamException : {}", exception.getMessage(), exception);
        }
